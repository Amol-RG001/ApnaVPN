...
public class BatterySaver implements Parcelable {
    ...
    protected BatterySaver(Parcel in) {
    ...
    public static final Creator<BatterySaver> CREATOR = new Creator<BatterySaver>() {
        @Override
        public BatterySaver createFromParcel(Parcel in) {
            return new BatterySaver(in);
        }

        @Override
        public BatterySaver[] newArray(int size) {
            return new BatterySaver[size];
        }
    };
